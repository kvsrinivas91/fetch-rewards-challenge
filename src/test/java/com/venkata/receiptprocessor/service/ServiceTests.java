package com.venkata.receiptprocessor.service;

import com.venkata.receiptprocessor.DTO.PostResponseDTO;
import com.venkata.receiptprocessor.jpa.ItemRepository;
import com.venkata.receiptprocessor.jpa.ReceiptRepository;
...
public class ServiceTests {
    ...
    public void testUniqueProducts(){
        boolean uniqueProducts = receiptService.calculateUniqueProductsPoints(receipt.getItems());

        assertEquals(true, uniqueProducts);

//        boolean uniqueProducts2 = receiptService.calculateUniqueProductsPoints(receipt2.getItems());
//
//        assertEquals(false, uniqueProducts2);
    ...
    private Receipt createTestReceipt() {
        Item item = Item.builder()
                .shortDescription("Mil")
                .price("110")
                .build();

        Item item1 = Item.builder()
                .shortDescription("Mil1")
                .price("10")
                .build();
    ...
    private Receipt createTestReceipt2() {
        Item item = Item.builder()
        ...
        Receipt receipt2 = Receipt.builder().id("bf304611-7746-4f46-b682-1395096106ef")
                .retailer("Walmart")
                .purchaseDate("2020-01-01")
                .purchaseTime("10:00")
